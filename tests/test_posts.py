...
#     posts = [schema.PostOut(**item_json) for item_json in res.json()]
...
#     res = client.post("/posts/", json={"title": "arbitrary title", "content": "asd"})
#     assert res.status_code == 401
...
def test_update_post_non_exist(authorized_client, test_user, test_posts):
    res = authorized_client.put(f"/posts/88888", json={"title": "arbitrary content", "content": "arbitrary content"})
    assert res.status_code == 404